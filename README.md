...
Only MARKET entries and margin sizing are supported in this version. SQLite is used to keep deployment to one container. LIMIT orders, fixed quantity and multiple positions are intentionally unsupported.
